...
| banana_var_bc | Dirichlet strength | lam_d ∈ {0.3, 1, 3}, K=100, lam=0.01 | 6 | 5/6 done — pins v_mag (32→2), recon flat; lam_d=3 s1 re-slot |
...
|---|---|---|---|---|---|---|---|
| mog_var | mog | 2 | recon | variational | 5000 | 2 | ✖ cancelled 602172–602173 — re-slot |
| spirals_var | spirals | 2 | class | variational | 5000 | 2 | ✖ cancelled 602174–602175 — re-slot |
| rings_var | rings | 2 | class | variational | 5000 | 2 | running (602265-602266) |
| breast_cancer_var | breast_cancer | 30 | class | variational | 3000 | 2 | running s0 (602267); s1 queued later |
